...
//	reg [31:0] out_Acc_Counter;
    ...
    //UART uart(rx, clk, reset, finish_program, out_Acc_Counter, tx, BIP_enable);    
    Data_memory #(.INIT_FILE("/home/vlad/Documents/Arquitectura2018/datos.txt")) Data_memory (.Wr(WrRAM),.clk(clk),.ena(BIP_enable), .Addr(Addr), .In_Data(In_Data), .Out_Data(Out_Data));
    Program_memory #(.INIT_FILE("/home/vlad/Documents/Arquitectura2018/instrucciones.txt")) Program_memory (1'b0, clk, BIP_enable, PC, 0, Program_Data);
